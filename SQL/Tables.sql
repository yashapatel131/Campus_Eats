...
CREATE TABLE `driver_rating` (
  ...
  KEY `fk_DR_rating_id` (`rd_id`),
  CONSTRAINT `fk_DR_rating_id` FOREIGN KEY (`rd_id`) REFERENCES `rating` (`rating_id`)
...
CREATE TABLE `rating` (
  ...
  KEY `fk_R_order_id` (`o_id`),
  CONSTRAINT `fk_R_order_id` FOREIGN KEY (`o_id`) REFERENCES `order` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `restaurant_rating` (
  ...
  KEY `fk_RR_rating_id` (`rr_id`),
  CONSTRAINT `fk_RR_rating_id` FOREIGN KEY (`rr_id`) REFERENCES `rating` (`rating_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Final view structure for view `price_rating`
--

/*!50001 DROP VIEW IF EXISTS `price_rating`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
/*!50001 SET character_set_client      = utf8mb4 */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `price_rating` AS select `o`.`total_price` AS `total_price`,`r`.`rating_id` AS `rating_id`,count(0) AS `rating_count`,`r`.`stars` AS `stars` from (`rating` `r` join `order` `o` on((`r`.`o_id` = `o`.`order_id`))) where (`o`.`total_price` > 10) group by `r`.`rating_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `rating_dr`
--

/*!50001 DROP VIEW IF EXISTS `rating_dr`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
/*!50001 SET character_set_client      = utf8mb4 */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `rating_dr` AS select `r`.`rating_id` AS `rating_id`,`r`.`stars` AS `stars`,`d`.`attitude` AS `driver_attitude`,`rr`.`quality` AS `food_quality` from (((`rating` `r` join `order` `o`) join `driver_rating` `d`) join `restaurant_rating` `rr`) where ((`r`.`o_id` = `o`.`order_id`) and (`d`.`rd_id` = `r`.`rating_id`) and (`rr`.`rr_id` = `r`.`rating_id`)) group by `r`.`rating_id` order by `r`.`rating_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `rating_summary`
--

/*!50001 DROP VIEW IF EXISTS `rating_summary`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
/*!50001 SET character_set_client      = utf8mb4 */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `rating_summary` AS select `r`.`rating_id` AS `rating_id`,count(0) AS `rating_count`,avg(`r`.`stars`) AS `average_rating` from (`rating` `r` join `order` `o` on((`r`.`o_id` = `o`.`order_id`))) group by `r`.`rating_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `view_haps`
--

/*!50001 DROP VIEW IF EXISTS `view_haps`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
/*!50001 SET character_set_client      = utf8mb4 */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_haps` AS select `restaurant`.`restaurant_id` AS `restaurant_id`,`restaurant`.`location` AS `location`,`restaurant`.`restaurant_name` AS `restaurant_name`,`restaurant`.`schedule` AS `schedule`,`restaurant`.`website` AS `website` from `restaurant` where (`restaurant`.`restaurant_id` = 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2021-04-26 17:24:45
